...
{   
    ...
    GLuint texture;
    //GLuint t = glGetUniformLocation(shader_program,"")
    string s = "wood.png";
    const char *path = s.c_str();
    GLuint plane_texture = loadTexture(path,false);
    GLuint plane_texture_gamma_corrected = loadTexture(path,true);
    ...
    do
    {
        ...
        if(gammaEnabled)
        {
            texture = plane_texture_gamma_corrected;
        }
        else
        {
        ...
        GLuint lightPos = glGetUniformLocation(shader_program,"lightPositions");
        GLuint lightcol_pos = glGetUniformLocation(shader_program,"lightColors"); 
        GLuint vPos = glGetUniformLocation(shader_program,"viewPos");
        GLuint gLoc = glGetUniformLocation(shader_program,"gamma");
        ...
        glUniform3fv(lightPos,4,value_ptr(lightPositions[0]));
        glUniform3fv(lightcol_pos,4,value_ptr(lightColors[0]));
        glUniform3fv(vPos,1,value_ptr(cameraPos));
        glUniform1f(gLoc,gammaEnabled);
